...
def build_optimizable_model(
    model, attributes, optimizer, loss_fn, validation_metric, increasing,
    train_dataset, validation_dataset, batch_size, epochs, 
    verbose=False, directory=TMP_DIRECTORY, tuner='Bayesian',
    ...
    # User opted for hyper-parameter tuning
        ...
        if tuner == 'Bayesian':
            tuner = kt.BayesianOptimization(
                hypermodel = HyperOptimizationModel(model, attributes, optimizer, loss_fn, validation_metric, regularization_range),
