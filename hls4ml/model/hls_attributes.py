...
from hls4ml.model.hls_types import TensorVariable, WeightVariable
...
class TypeAttribute(Attribute):
    def __init__(self, name, default=None, configurable=True):
        if not name.endswith('_t'):
            name += '_t'
        super(TypeAttribute, self).__init__(name, value_type=None, default=default, configurable=configurable)
