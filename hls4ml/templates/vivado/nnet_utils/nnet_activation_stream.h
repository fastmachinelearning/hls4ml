...
void softmax(hls::stream<data_T> &data, hls::stream<res_T> &res){
    std::cout << "softmax stream ver activated " << CONFIG_T::table_size << "\n";
...
// template <class data_T, class res_T, typename CONFIG_T>
// void softmax_aggregation(hls::stream<data_T> &data, hls::stream<res_T> &res){
//     /*
//     taken from softmax_latency,
//     implementation of softmax, but with 
//     */
//     // Initialize the lookup tables
// #ifdef __HLS_SYN__
//     bool initialized = false;
