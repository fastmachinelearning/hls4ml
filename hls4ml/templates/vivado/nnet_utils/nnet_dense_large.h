...
void dense_large_rf_leq_nin(
    ...
    for (int ir = 0; ir < rufactor; ir++) {
        ...
        for (int im = 0; im < block_factor; im++) {
            ...
            acc[out_index] += product<data_T, typename CONFIG_T::weight_t, typename CONFIG_T::accum_t, CONFIG_T>(data[in_index], weights[w_index]);
...
void dense_large_rf_gt_nin(
    ...
    for (int ir = 0; ir < rufactor; ir++) {
        ...
        for (int im = 0; im < block_factor; im++) {
            ...
            tmpmult[im] = product<data_T, typename CONFIG_T::weight_t, typename CONFIG_T::accum_t, CONFIG_T>(data[in_index], weights[w_index]);
        }
