...
namespace nnet {
  namespace garnet_utils {
    ...
    template<class CONFIG_T, class edge_weight_T = float, class sfeature_T = float>
    inline
    void
    initialize_sums(
    ...
    // No unsigned feature optimization, normalization by nvtx
    template<class CONFIG_T, class nvtx_T = unsigned, class sfeature_T = float>
    inline
    void
    normalize_sums(
      nvtx_T const nvtx,
    ...
    // Unsigned feature optimization, normalization by nvtx
    ...
    // No unsigned feature optimization, normalization by CONFIG_T::n_vertices (constant)
    ...
    // Unsigned feature optimization, normalization by CONFIG_T::n_vertices (constant)
    template<class CONFIG_T, class sfeature_T = float, class ufeature_T = float>
    inline void
    normalize_sums(
      typename CONFIG_T::edge_weight_aggr_t const edge_weight_accum[CONFIG_T::n_aggregators],
    ...
    // No unsigned feature optimization
    ...
    {
      garnet_utils::initialize_sums<CONFIG_T>(edge_weight_mean, weighted_sfeature_mean);
      ...
      garnet_utils::initialize_sums<CONFIG_T>(edge_weight_accum, weighted_sfeature_accum);
     ...
     VerticesOuter:
      for (unsigned ivv = 0; ivv < CONFIG_T::reuse_factor; ++ivv) {
        ...
        garnet_utils::initialize_sums<CONFIG_T>(edge_weight_mean_local, weighted_sfeature_mean_local);
      ...
      if (CONFIG_T::mean_by_nvert)
        normalize_sums<CONFIG_T>(nvtx, edge_weight_accum, weighted_sfeature_accum, edge_weight_mean, weighted_sfeature_mean);
      else
        normalize_sums<CONFIG_T>(edge_weight_accum, weighted_sfeature_accum, edge_weight_mean, weighted_sfeature_mean);
    }

    // Unsigned feature optimization
  ...
  // No unsigned feature optimization, vertices -> vertices
  ...
  // Unsigned feature optimization, vertices -> vertices
  ...
  // No unsigned feature optimization, vertices -> out features
  template<class data_T, class nvtx_T, class res_T, typename CONFIG_T>
  ...
  // Unsigned feature optimization, vertices -> out features
  template<class data_T, class udata_T, class nvtx_T, class res_T, typename CONFIG_T>
  typename std::enable_if<CONFIG_T::output_collapse == CONFIG_T::collapse_mean>::type
  garnet(
    data_T const data[CONFIG_T::n_vertices * CONFIG_T::n_in_sfeatures],
