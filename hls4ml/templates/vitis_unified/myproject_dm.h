...
#include "MY_PROJECT_AXI.h"

#define DMX_BUF_IN_SZ   VAL
#define DMX_BUF_OUT_SZ  VAL


static void load_input(float* in, hls::stream<dma_data_packet>& inStream, int size) {
mem_rd:
...
void MY_PROJECT(float* in, float* out, int inSize, int outSize){
