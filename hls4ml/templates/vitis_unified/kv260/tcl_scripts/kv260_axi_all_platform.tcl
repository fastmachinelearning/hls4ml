...
\
  ...
  # Create instance: customIntr_0, and set properties
  set customIntr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 customIntr_0 ]
  ...
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins customIntr_0/In0]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins customIntr_0/dout] [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk]
  ...
  set_property PFM_NAME {vendor:kv260_som_som240_1_connector_kv260_carrier_som240_1_connector:kv260pf:0.0} [get_files [current_bd_design].bd]
  set_property PFM.AXIS_PORT {M_AXIS_MM2S {type "M_AXIS" sptag "DMA_MM2S" is_range "false"} S_AXIS_S2MM {type "S_AXIS" sptag "DMA_S2MM" is_range "false"}} [get_bd_cells /axi_dma_0]
  set_property PFM.AXI_PORT {M02_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M03_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M04_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M05_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M06_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } M07_AXI { memport "M_AXI_GP" sptag "" memory "" is_range "false" } } [get_bd_cells /axi_interconnect_0]
  set_property PFM.AXI_PORT {M_AXI_HPM0_FPD { memport "M_AXI_GP" sptag "HPM0" memory "" is_range "false" } M_AXI_HPM1_FPD { memport "M_AXI_GP" sptag "HPM1" memory "" is_range "false" } S_AXI_HP0_FPD { memport "S_AXI_HP" sptag "HP0" memory "" is_range "false" } S_AXI_HP1_FPD { memport "S_AXI_HP" sptag "HP1" memory "" is_range "false" } S_AXI_HP2_FPD { memport "S_AXI_HP" sptag "HP2" memory "" is_range "false" } S_AXI_HP3_FPD { memport "S_AXI_HP" sptag "HP3" memory "" is_range "false" } S_AXI_HPC1_FPD { memport "S_AXI_HPC" sptag "HPC1" memory "" is_range "false" } } [get_bd_cells /zynq_ultra_ps_e_0]
  ...
  set_property PFM.IRQ {In1 {is_range "true"}} [get_bd_cells /customIntr_0]
