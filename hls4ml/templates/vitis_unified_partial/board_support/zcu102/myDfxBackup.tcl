...
proc cr_bd_system {} {
    ...
    proc create_hier_cell_magic_seqCtrl {parentCell nameHier amtMgs amtMgsIdx bank1Idx} {
        ...
        set MagicSeq_0 [ create_bd_cell -type ip -vlnv user.org:user:MagicSeq:1.0 MagicSeq_0 ]
        set_property -dict [list \
        CONFIG.BANK1_INDEX_WIDTH  $bank1Idx \
        CONFIG.BANK0_CNT_WIDTH    $bank1Idx \
        CONFIG.BANK1_LD_MSK_WIDTH [expr {$amtMgsIdx+1}] \
        CONFIG.BANK1_ST_MSK_WIDTH [expr {$amtMgsIdx+1}] \
        ] $MagicSeq_0
    ...
    create_hier_cell_data_mover      [current_bd_instance .] data_mover     $AMT_MGS
    create_hier_cell_magic_seqCtrl   [current_bd_instance .] magic_seq_ctrl $AMT_MGS $MGS_IDX $BANK_IDX_WIDTH
    create_hier_cell_dfx_decup       [current_bd_instance .] dfx_decup_s      $AMT_MGS
    create_hier_cell_dfx_decup       [current_bd_instance .] dfx_decup_m      $AMT_MGS
    create_hier_cell_dfx_par         [current_bd_instance .] dfx_par  $AMT_MGS $MGS_WIDTH
