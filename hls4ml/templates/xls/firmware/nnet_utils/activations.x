...
pub fn softmax_stable
    ...
    // Compute exp() with Lookup Tables
    let exp_result = for (i, exp_vec): (u32, sN[NB_OUT][VEC_SZ]) in u32:0..VEC_SZ {
        let exp_table_idx = lookup_tables::idx_from_real_val<TABLE_SZ, NB_IN>(d_yi_ymax[i]);
        update(exp_vec, i, lookup_tables::EXP_TABLE[exp_table_idx]) 
    }(sN[NB_OUT][VEC_SZ]:[sN[NB_OUT]:0, ...]);
...
fn softmax_stable_test() {
    ...
    assert_eq(expected, softmax_stable<u32:16, u32:1, u32:10, u32:18, u32:1, u32:10, u32:1024>(x));
