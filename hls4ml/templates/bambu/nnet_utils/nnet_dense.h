...
// at runtime.
template <class data_T, class res_T, typename CONFIG_T> void dense(data_T data[CONFIG_T::n_in], res_T res[CONFIG_T::n_out]) {
    #pragma HLS inline
    CONFIG_T::template kernel<data_T, res_T, CONFIG_T>::dense(data, res, CONFIG_T::weights, CONFIG_T::biases);
}
