...
from hls4ml.backends.vitis.passes.fifo_depth_optimization import (initialize_large_fifos, \
...
def get_vitis_optimized_fifo_depths(model, cus_hls_prj_path = None):
    ...
    if cus_hls_prj_path is None:
        cus_hls_prj_path = model.config.get_output_dir() \
        + '/' \
    ...
    path_to_zip_file = (
        cus_hls_prj_path
        + '/.autopilot/db/channel_depth_info/'
    )
