...
from hls4ml.backends.fpga.fpga_types import ACTypeConverter, HLSTypeConverter, StaticWeightVariableConverter, CatapultArrayVariableConverter, CatapultInplaceVariableConverter, CatapultStreamVariableConverter
...
class TransformTypes(GlobalOptimizerPass):
    def __init__(self):
        ...
        self.inplace_var_converter = CatapultInplaceVariableConverter(type_converter=self.type_converter)
