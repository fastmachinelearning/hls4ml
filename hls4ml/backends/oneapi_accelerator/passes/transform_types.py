...
from hls4ml.backends.oneapi_accelerator.oneapi_accelerator_types import (
    OneAPIAcceleratorInterfaceVariableConverter,
)
...
class TransformTypes(GlobalOptimizerPass):
    def __init__(self):
        ...
        self.interface_var_converter = OneAPIAcceleratorInterfaceVariableConverter(type_converter=self.type_converter)
