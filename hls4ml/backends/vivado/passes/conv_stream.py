from hls4ml.model.layers import Conv1D, Conv2D, SeparableConv1D, SeparableConv2D, Conv2DTranspose, Conv1DTranspose
...
class GenerateConvStreamingInstructions(OptimizerPass):
    ...
    def _generate_1d_instructions(self, node):
        ...
        if isinstance(node, Conv1DTranspose):
            ...
            kernel_width = (node.get_attr('filt_width') + node.get_attr('stride_width')-1) \
