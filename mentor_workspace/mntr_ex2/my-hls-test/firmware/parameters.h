...
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> accum_default_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> weight_default_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> bias_default_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> input_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> result_t;
#define N_INPUTS 16
#define N_LAYER_1 64
#define N_LAYER_2 32
#define N_LAYER_3 32
...
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> layer1_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> layer2_t;
typedef ap_fixed<16,6, AP_TRN_ZERO, AP_WRAP> layer3_t;
