...
def create_model():
	...
	model.add(tf.keras.layers.ELU(2))
...
if __name__ == '__main__':
    model = create_model()
    save_model(model, name='elu')

    # Image Matrix
    image_mat = np.array([
	[1, -2.2,  3, -4.4,  5, -5.5,  1, -2.2,  3, -4.4,  4, -5.5,  1, -2.2,  3, -3.3,  4, -5.5,  1, -2.2,  2, -3.3,  4, -5.5, 1]
    ])
