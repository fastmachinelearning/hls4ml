...
struct config1 : nnet::large_layer_config {
        ...
        static const unsigned reuse_factor = 440;
        static const unsigned n_zeros = 257400;
...
struct config2 : nnet::large_layer_config {
        ...
        static const unsigned io_type = nnet::io_parallel;
        static const unsigned reuse_factor = 600;
        static const unsigned n_zeros = 117000;
        static const bool store_weights_in_bram = true;
        typedef accum_default_t accum_t;
        typedef bias_default_t bias_t;
        typedef weight_default_t weight_t;
...
struct config3 : nnet::large_layer_config {
        ...
        static const unsigned n_zeros = 7800;
        static const bool store_weights_in_bram = true;
        typedef accum_default_t accum_t;
        typedef bias_default_t bias_t;
        typedef weight_default_t weight_t;
