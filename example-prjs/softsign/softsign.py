...
def create_model():
	...
	model.add(tf.keras.layers.Conv2D(1, 3, 1, padding="valid", activation="softsign", kernel_initializer=random_kernel, input_shape=(5, 5, 1)))
...
if __name__ == '__main__':
    model = create_model()
    save_model(model, name='softsign')
