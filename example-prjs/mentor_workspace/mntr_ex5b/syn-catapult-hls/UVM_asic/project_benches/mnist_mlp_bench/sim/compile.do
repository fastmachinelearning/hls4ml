...
quietly set ::env(UVMF_PROJECT_DIR) ../../../project_benches/mnist_mlp_bench
...
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/ccs_pkg/compile.do

do $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/mnist_mlp_env_pkg/compile.do

vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/mnist_mlp_bench_parameters_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/mnist_mlp_bench_sequences_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/mnist_mlp_bench_tests_pkg.sv
