...
open_project -reset keras3layer_prj
set_top keras3layer
add_files ../keras_3layer/firmware/keras3layer.cpp -cflags "-std=c++0x"
add_files -tb ../keras_3layer/sc_main.cpp -cflags "-std=c++0x"
add_files -tb ../keras_3layer/firmware/weights
...
if {$opt(synth)} {
  ...
  if {$opt(cosim)} {
    ...
    add_files -tb ../keras_3layer/sc_main.cpp -cflags "-std=c++0x -DRTL_SIM"
    set time_start [clock clicks -milliseconds]
