...
RTLTOOL          Vivado
TECHNOLOGY       KINTEX-u
LIBRARY          mnist_mlp_w6_RAMS
MODULE           w6_data2304_1w8r
OUTPUT_DIR       memlib 
FILES {
  { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/mntr_ex5/memlibs/memlib/w6_data2304_1w8r.v          FILETYPE Verilog MODELTYPE synthesis PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
...
PINMAPS {
  ...
  { PHYPIN D0   LOGPIN DATA_IN      DIRECTION in  WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_0                                                                                                                          }
  { PHYPIN WE0  LOGPIN WRITE_ENABLE DIRECTION in  WIDTH 1.0     PHASE 1  DEFAULT {} PORTS port_0                                                                                                                          }
  { PHYPIN WEM0 LOGPIN WRITE_MASK   DIRECTION in  WIDTH 2304.0 PHASE 1  DEFAULT {} PORTS port_0                                                                                                                          }
  ...
  { PHYPIN Q1   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_1                                                                                                                          }
  ...
  { PHYPIN Q2   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_2                                                                                                                          }
  ...
  { PHYPIN Q3   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_3                                                                                                                          }
  ...
  { PHYPIN Q4   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_4                                                                                                                          }
  ...
  { PHYPIN Q5   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_5                                                                                                                          }
  ...
  { PHYPIN Q6   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_6                                                                                                                          }
  ...
  { PHYPIN Q7   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_7                                                                                                                          }
  ...
  { PHYPIN Q8   LOGPIN DATA_OUT     DIRECTION out WIDTH 2304.0 PHASE {} DEFAULT {} PORTS port_8                                                                                                                          }
}
