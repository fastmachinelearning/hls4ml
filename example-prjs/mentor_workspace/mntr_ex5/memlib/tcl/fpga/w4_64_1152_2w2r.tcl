...
flow run /MemGen/MemoryGenerator_BuildLibWithTempDir {
    ...
    MODULE w4_64_1152_2w2r
    LIBRARY w4_Xilinx_RAMS
    WIDTH 1152
    DEPTH 64
    AREA 0
    ...
    VERILOGARRAYPATH {}
    FILES {
        { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/mntr_ex5/memlib/fpga/w4_64_1152_2w2r.v
    ...
    PINMAPS {
        ...
        {PHYPIN D0   LOGPIN DATA_IN      DIRECTION in  WIDTH 1152.0 PHASE {} DEFAULT {} PORTS port_1}
        {PHYPIN WE0  LOGPIN WRITE_ENABLE DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_1}
        {PHYPIN WEM0 LOGPIN WRITE_MASK   DIRECTION in  WIDTH 1152.0 PHASE 1  DEFAULT {} PORTS port_1}
        ...
        {PHYPIN D1   LOGPIN DATA_IN      DIRECTION in  WIDTH 1152.0 PHASE {} DEFAULT {} PORTS port_2}
        {PHYPIN WE1  LOGPIN WRITE_ENABLE DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_2}
        {PHYPIN WEM1 LOGPIN WRITE_MASK   DIRECTION in  WIDTH 1152.0 PHASE 1  DEFAULT {} PORTS port_2}
        ...
        {PHYPIN Q2   LOGPIN DATA_OUT     DIRECTION out WIDTH 1152.0 PHASE {} DEFAULT {} PORTS port_3}
        ...
        {PHYPIN Q3   LOGPIN DATA_OUT     DIRECTION out WIDTH 1152.0 PHASE {} DEFAULT {} PORTS port_4}
    }
}
