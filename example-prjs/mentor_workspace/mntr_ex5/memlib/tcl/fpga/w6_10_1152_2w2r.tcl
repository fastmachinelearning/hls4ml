...
flow run /MemGen/MemoryGenerator_BuildLibWithTempDir {
    ...
    VERILOGARRAYPATH {}
    FILES {
        { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/mntr_ex5/memlib/fpga/w6_10_1152_2w2r.v
    ...
    PINMAPS {
        ...
        {PHYPIN A0   LOGPIN ADDRESS      DIRECTION in  WIDTH 4.0 PHASE {} DEFAULT {} PORTS port_1}
        ...
        {PHYPIN A1   LOGPIN ADDRESS      DIRECTION in  WIDTH 4.0 PHASE {} DEFAULT {} PORTS port_2}
        ...
        {PHYPIN A2   LOGPIN ADDRESS      DIRECTION in  WIDTH 4.0 PHASE {} DEFAULT {} PORTS port_3}
        ...
        {PHYPIN A3   LOGPIN ADDRESS      DIRECTION in  WIDTH 4.0 PHASE {} DEFAULT {} PORTS port_4}
