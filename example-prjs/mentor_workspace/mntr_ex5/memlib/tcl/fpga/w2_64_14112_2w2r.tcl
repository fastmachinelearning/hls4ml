...
flow run /MemGen/MemoryGenerator_BuildLibWithTempDir {
    ...
    MODULE w2_64_14112_2w2r
    LIBRARY w2_Xilinx_RAMS
    WIDTH 14112
    DEPTH 64
    AREA 0
    ...
    VERILOGARRAYPATH {}
    FILES {
        { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/mntr_ex5/memlib/fpga/w2_64_14112_2w2r.v
    ...
    PINMAPS {
        ...
        {PHYPIN A0   LOGPIN ADDRESS      DIRECTION in  WIDTH 6.0 PHASE {} DEFAULT {} PORTS port_1}
        {PHYPIN D0   LOGPIN DATA_IN      DIRECTION in  WIDTH 14112.0 PHASE {} DEFAULT {} PORTS port_1}
        {PHYPIN WE0  LOGPIN WRITE_ENABLE DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_1}
        {PHYPIN WEM0 LOGPIN WRITE_MASK   DIRECTION in  WIDTH 14112.0 PHASE 1  DEFAULT {} PORTS port_1}
        {PHYPIN CE1  LOGPIN PORT_ENABLE  DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_2}
        {PHYPIN A1   LOGPIN ADDRESS      DIRECTION in  WIDTH 6.0 PHASE {} DEFAULT {} PORTS port_2}
        {PHYPIN D1   LOGPIN DATA_IN      DIRECTION in  WIDTH 14112.0 PHASE {} DEFAULT {} PORTS port_2}
        {PHYPIN WE1  LOGPIN WRITE_ENABLE DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_2}
        {PHYPIN WEM1 LOGPIN WRITE_MASK   DIRECTION in  WIDTH 14112.0 PHASE 1  DEFAULT {} PORTS port_2}
        {PHYPIN CE2  LOGPIN PORT_ENABLE  DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_3}
        {PHYPIN A2   LOGPIN ADDRESS      DIRECTION in  WIDTH 6.0 PHASE {} DEFAULT {} PORTS port_3}
        {PHYPIN Q2   LOGPIN DATA_OUT     DIRECTION out WIDTH 14112.0 PHASE {} DEFAULT {} PORTS port_3}
        {PHYPIN CE3  LOGPIN PORT_ENABLE  DIRECTION in  WIDTH 1.0  PHASE 1  DEFAULT {} PORTS port_4}
        {PHYPIN A3   LOGPIN ADDRESS      DIRECTION in  WIDTH 6.0 PHASE {} DEFAULT {} PORTS port_4}
        {PHYPIN Q3   LOGPIN DATA_OUT     DIRECTION out WIDTH 14112.0 PHASE {} DEFAULT {} PORTS port_4}
    }
}
