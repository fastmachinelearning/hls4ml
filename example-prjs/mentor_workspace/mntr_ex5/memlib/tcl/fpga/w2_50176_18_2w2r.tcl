...
flow run /MemGen/MemoryGenerator_BuildLibWithTempDir {
    ...
    VERILOGARRAYPATH {}
    FILES {
        { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/mntr_ex5/memlib/fpga/w2_50176_18_2w2r.v
          FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
        { FILENAME /home/giuseppe/research/projects/fastml/hls4ml-mentor.git/example-prjs/mentor_workspace/memgen/tech/virtex7/BRAM_4096x4.v
          FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
        { FILENAME /tools/Xilinx/Vivado/2019.1/data/verilog/src/retarget/RAMB16_S4_S4.v
          FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
        { FILENAME /tools/Xilinx/Vivado/2019.1/data/verilog/src/unisims/RAMB18E1.v
          FILETYPE Verilog MODELTYPE generic PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
    ...
    PINMAPS {
        ...
        {PHYPIN A0   LOGPIN ADDRESS      DIRECTION in  WIDTH 16.0 PHASE {} DEFAULT {} PORTS port_1}
        ...
        {PHYPIN A1   LOGPIN ADDRESS      DIRECTION in  WIDTH 16.0 PHASE {} DEFAULT {} PORTS port_2}
        ...
        {PHYPIN A2   LOGPIN ADDRESS      DIRECTION in  WIDTH 16.0 PHASE {} DEFAULT {} PORTS port_3}
        ...
        {PHYPIN A3   LOGPIN ADDRESS      DIRECTION in  WIDTH 16.0 PHASE {} DEFAULT {} PORTS port_4}
