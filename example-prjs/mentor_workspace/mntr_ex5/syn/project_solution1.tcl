...
##directive set /myproject/nnet::softmax<result_t,result_t,softmax_config4> -MAP_TO_MODULE {[CCORE]}
...
##directive set /myproject/nnet::relu<layer1_t,layer1_t,relu_config1> -MAP_TO_MODULE {[CCORE]}
##directive set /myproject/nnet::relu<layer3_t,layer3_t,relu_config3> -MAP_TO_MODULE {[CCORE]}
#
#go assembly
#
## I/O
...
#
## Arrays
##directive set /myproject/core/nnet::relu<layer1_t,layer1_t,relu_config1>(logits1):rsc -MAP_TO_MODULE {[Register]}
##directive set /myproject/core/nnet::compute_layer<layer1_t,layer2_t,config2>(layer1_out):rsc -MAP_TO_MODULE {[Register]}
##directive set /myproject/core/nnet::relu<layer2_t,layer2_t,relu_config2>(logits2):rsc -MAP_TO_MODULE {[Register]}
