...
set_top keras1layer
add_files firmware/keras1layer.cpp -cflags "-std=c++0x"
add_files -tb keras1layer_test.cpp -cflags "-std=c++0x"
...
if {$opt(synth)} {
  ...
  if {$opt(cosim)} {
    ...
    add_files -tb keras1layer_test.cpp -cflags "-std=c++0x -DRTL_SIM"
    set time_start [clock clicks -milliseconds]
