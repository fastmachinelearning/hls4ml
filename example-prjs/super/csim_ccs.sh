...
echo "====================================================="
echo "C++ EXECUTION"
rm -f a.out; $MGC_HOME/bin/g++ -g -std=c++17 -I. -DWEIGHTS_DIR=\"qresource64-Catapult/firmware/weights\" -Iqresource64-Catapult/firmware -I$MGC_HOME/shared/include qresource64-Catapult/firmware/myproject.cpp qresource64-Catapult/myproject_test.cpp;
perf record -g ./a.out
# python3 agrmax.py
