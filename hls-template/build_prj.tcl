...
set_top myproject
add_files firmware/myproject.cpp -cflags "-I[file normalize nnet_utils] -DWEIGHTS_DIR=[file normalize ./firmware/weights] -std=c++0x -DVALIDATION"
add_files -tb myproject_test.cpp -cflags "-I[file normalize nnet_utils] -DWEIGHTS_DIR=[file normalize ./firmware/weights] -std=c++0x -DVALIDATION"
