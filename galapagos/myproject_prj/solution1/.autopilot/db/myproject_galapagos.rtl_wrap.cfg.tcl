...
set DataType04 "[list ap_uint 40 ]"
...
set DataType0 [list "galapagos_packet" "struct " $structMem0 0 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType14 "[list ap_uint 40 ]"
...
set DataType1 [list "galapagos_packet" "struct " $structMem1 0 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
