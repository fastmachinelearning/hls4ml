...
#ifndef __myproject_galapagzec__HH__
#define __myproject_galapagzec__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagzec) {
    ...
    SC_CTOR(myproject_galapagzec):  ACMP_mul_su_U ("ACMP_mul_su_U") {
