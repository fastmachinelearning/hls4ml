...
#ifndef __myproject_galapagsc4__HH__
#define __myproject_galapagsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagsc4) {
    ...
    SC_CTOR(myproject_galapagsc4):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
