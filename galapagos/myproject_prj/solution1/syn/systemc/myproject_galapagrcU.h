...
#ifndef __myproject_galapagrcU__HH__
#define __myproject_galapagrcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagrcU) {
    ...
    SC_CTOR(myproject_galapagrcU):  ACMP_mul_su_U ("ACMP_mul_su_U") {
