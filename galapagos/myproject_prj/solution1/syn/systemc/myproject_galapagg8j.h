...
#ifndef __myproject_galapagg8j__HH__
#define __myproject_galapagg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagg8j) {
    ...
    SC_CTOR(myproject_galapagg8j):  ACMP_mul_us_U ("ACMP_mul_us_U") {
