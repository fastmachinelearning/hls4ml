...
#ifndef __myproject_galapagfYi__HH__
#define __myproject_galapagfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagfYi) {
    ...
    SC_CTOR(myproject_galapagfYi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
