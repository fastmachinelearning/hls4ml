...
#ifndef __myproject_galapagbkb__HH__
#define __myproject_galapagbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagbkb) {
    ...
    SC_CTOR(myproject_galapagbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
