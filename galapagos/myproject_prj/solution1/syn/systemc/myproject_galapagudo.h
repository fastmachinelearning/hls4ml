...
#ifndef __myproject_galapagudo__HH__
#define __myproject_galapagudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagudo) {
    ...
    SC_CTOR(myproject_galapagudo):  ACMP_mul_su_U ("ACMP_mul_su_U") {
