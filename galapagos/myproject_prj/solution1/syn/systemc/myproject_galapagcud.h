...
#ifndef __myproject_galapagcud__HH__
#define __myproject_galapagcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagcud) {
    ...
    SC_CTOR(myproject_galapagcud):  ACMP_mul_us_U ("ACMP_mul_us_U") {
