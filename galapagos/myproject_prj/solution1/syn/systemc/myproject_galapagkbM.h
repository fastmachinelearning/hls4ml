...
#ifndef __myproject_galapagkbM__HH__
#define __myproject_galapagkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagkbM) {
    ...
    SC_CTOR(myproject_galapagkbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
