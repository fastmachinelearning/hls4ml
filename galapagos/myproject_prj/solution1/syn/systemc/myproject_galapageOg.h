...
#ifndef __myproject_galapageOg__HH__
#define __myproject_galapageOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapageOg) {
    ...
    SC_CTOR(myproject_galapageOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
