...
#ifndef __myproject_galapagyd2__HH__
#define __myproject_galapagyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagyd2) {
    ...
    SC_CTOR(myproject_galapagyd2):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
