...
#ifndef __myproject_galapagwdI__HH__
#define __myproject_galapagwdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagwdI) {
    ...
    SC_CTOR(myproject_galapagwdI):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
