...
#ifndef __myproject_galapagpcA__HH__
#define __myproject_galapagpcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagpcA) {
    ...
    SC_CTOR(myproject_galapagpcA):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
