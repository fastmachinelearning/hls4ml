...
#ifndef __myproject_galapagjbC__HH__
#define __myproject_galapagjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagjbC) {
    ...
    SC_CTOR(myproject_galapagjbC):  ACMP_mul_us_U ("ACMP_mul_us_U") {
