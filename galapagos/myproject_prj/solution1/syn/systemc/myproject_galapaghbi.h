...
#ifndef __myproject_galapaghbi__HH__
#define __myproject_galapaghbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapaghbi) {
    ...
    SC_CTOR(myproject_galapaghbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
