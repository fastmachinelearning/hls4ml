...
#ifndef __myproject_galapagocq__HH__
#define __myproject_galapagocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagocq) {
    ...
    SC_CTOR(myproject_galapagocq):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
