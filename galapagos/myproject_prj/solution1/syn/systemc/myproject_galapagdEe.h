...
#ifndef __myproject_galapagdEe__HH__
#define __myproject_galapagdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagdEe) {
    ...
    SC_CTOR(myproject_galapagdEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
