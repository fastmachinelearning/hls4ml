...
#ifndef __myproject_galapagqcK__HH__
#define __myproject_galapagqcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagqcK) {
    ...
    SC_CTOR(myproject_galapagqcK):  ACMP_mul_su_U ("ACMP_mul_su_U") {
