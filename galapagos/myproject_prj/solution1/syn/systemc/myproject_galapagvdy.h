...
#ifndef __myproject_galapagvdy__HH__
#define __myproject_galapagvdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagvdy) {
    ...
    SC_CTOR(myproject_galapagvdy):  ACMP_mul_su_U ("ACMP_mul_su_U") {
