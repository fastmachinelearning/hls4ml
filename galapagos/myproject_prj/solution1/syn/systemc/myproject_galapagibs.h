...
#ifndef __myproject_galapagibs__HH__
#define __myproject_galapagibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagibs) {
    ...
    SC_CTOR(myproject_galapagibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
