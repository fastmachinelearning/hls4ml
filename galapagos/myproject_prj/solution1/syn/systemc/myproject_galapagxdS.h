...
#ifndef __myproject_galapagxdS__HH__
#define __myproject_galapagxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagxdS) {
    ...
    SC_CTOR(myproject_galapagxdS):  ACMP_mul_su_U ("ACMP_mul_su_U") {
