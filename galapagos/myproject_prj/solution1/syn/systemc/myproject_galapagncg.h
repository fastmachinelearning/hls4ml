...
#ifndef __myproject_galapagncg__HH__
#define __myproject_galapagncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_galapagncg) {
    ...
    SC_CTOR(myproject_galapagncg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
