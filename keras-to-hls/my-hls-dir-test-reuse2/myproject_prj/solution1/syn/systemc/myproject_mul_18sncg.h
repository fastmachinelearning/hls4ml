...
#ifndef __myproject_mul_18sncg__HH__
#define __myproject_mul_18sncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_18sncg) {
    ...
    SC_CTOR(myproject_mul_18sncg):  ACMP_mul_su_U ("ACMP_mul_su_U") {
