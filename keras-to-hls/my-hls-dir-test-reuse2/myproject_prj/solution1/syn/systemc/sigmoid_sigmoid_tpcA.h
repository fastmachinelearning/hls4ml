...
#ifndef __sigmoid_sigmoid_tpcA_H__
#define __sigmoid_sigmoid_tpcA_H__
...
struct sigmoid_sigmoid_tpcA_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_tpcA_ram) {
...
SC_MODULE(sigmoid_sigmoid_tpcA) {
...
sigmoid_sigmoid_tpcA_ram* meminst;


SC_CTOR(sigmoid_sigmoid_tpcA) {
meminst = new sigmoid_sigmoid_tpcA_ram("sigmoid_sigmoid_tpcA_ram");
