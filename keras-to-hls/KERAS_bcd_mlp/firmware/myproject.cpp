		  ...
		  unsigned short &const_size_out)
{
    ...
    load_txt_file< weight_default_t, config4::n_in * config4::n_out >(w4, "w4.txt");
    load_txt_file< bias_default_t, config4::n_out >(b4, "b4.txt");
#endif
    ...
    nnet::compute_large_layer<layer2_t, layer3_t, config3>(layer2_out, logits3, w3, b3);
    ...
    nnet::compute_large_layer<layer3_t, result_t, config4>(layer3_out, logits4, w4, b4);
