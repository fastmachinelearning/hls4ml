...
#ifndef __sigmoid_sigmoid_tmb6_H__
#define __sigmoid_sigmoid_tmb6_H__
...
struct sigmoid_sigmoid_tmb6_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sigmoid_sigmoid_tmb6_ram) {
...
SC_MODULE(sigmoid_sigmoid_tmb6) {
...
sigmoid_sigmoid_tmb6_ram* meminst;


SC_CTOR(sigmoid_sigmoid_tmb6) {
meminst = new sigmoid_sigmoid_tmb6_ram("sigmoid_sigmoid_tmb6_ram");
