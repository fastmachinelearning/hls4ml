...
#ifndef __myproject_mul_18sdEe__HH__
#define __myproject_mul_18sdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_18sdEe) {
    ...
    SC_CTOR(myproject_mul_18sdEe):  ACMP_mul_su_U ("ACMP_mul_su_U") {
