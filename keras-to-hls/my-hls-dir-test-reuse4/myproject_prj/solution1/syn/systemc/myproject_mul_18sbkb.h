...
#ifndef __myproject_mul_18sbkb__HH__
#define __myproject_mul_18sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_18sbkb) {
    ...
    SC_CTOR(myproject_mul_18sbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
