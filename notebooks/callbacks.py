...
class all_callbacks(object):
    def __init__(self,
        ...
        self.modelcheckweights = ModelCheckpoint(outputDir + "/KERAS_check_model_last_weights.h5", verbose=1,
        ...
        self.callbacks = [
            self.nl_begin,
            self.modelbestcheck, self.modelbestcheckweights, self.modelcheck, self.modelcheckweights,
