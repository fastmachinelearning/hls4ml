...
class MyprojectClassFloat_ac2ad143;
...
void myproject_float(
    ...
    q.single_task<MyprojectClassFloat_ac2ad143>(Myproject{});
    nnet::convert_data_back<Layer4OutPipe, float, N_LAYER_4>(q, layer4_out);

    q.wait();
}

class MyprojectClassDouble_ac2ad143;
...
void myproject_double(
    ...
    q.single_task<MyprojectClassDouble_ac2ad143>(Myproject{});
    nnet::convert_data_back<Layer4OutPipe, double, N_LAYER_4>(q, layer4_out);
