...
def test_einsum_outer_product(backend, io_type):
    ...
    config = config_from_pytorch_model(model, [(None,4),(None,5)], default_precision='ap_fixed<16,6>',
...
def test_einsum_batch_matmul(backend, io_type):
    ...
    config = config_from_pytorch_model(model, [(None, 2, 5),(None, 5, 4)], default_precision='ap_fixed<16,6>',
            channels_last_conversion="internal",
            transpose_outputs=False,)
