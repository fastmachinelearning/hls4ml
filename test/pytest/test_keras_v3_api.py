...
@pytest.mark.parametrize('backend', ['Vivado', 'Vitis', 'Quartus', 'Altera', 'oneAPI', 'Catapult', 'XLS'])
...
@pytest.mark.parametrize('backend', ['Vivado', 'Vitis', 'Quartus', 'Altera', 'oneAPI', 'XLS'])
@pytest.mark.parametrize('io_type', ['io_parallel', 'io_stream'])
...
@pytest.mark.parametrize('backend', ['Vivado', 'Vitis', 'Quartus', 'Catapult', 'Altera', 'oneAPI', 'XLS'])
@pytest.mark.parametrize('io_type', ['io_parallel', 'io_stream'])
