...
@pytest.mark.parametrize('keras_model_1d', [{'model_type': 'max', 'keepdims': True},
                                            {'model_type': 'max', 'keepdims': False},
                                            {'model_type': 'avg', 'keepdims': True},
                                            {'model_type': 'avg', 'keepdims': False}],
                         ids = ['model_type-max-keepdims-True',
                                'model_type-max-keepdims-False',
                                'model_type-avg-keepdims-True',
                                'model_type-avg-keepdims-False'],
                         indirect=True)
...
@pytest.mark.parametrize('backend', ['Quartus', 'Vivado'])
@pytest.mark.parametrize('keras_model_2d', [{'model_type': 'max', 'keepdims': True},
                                            {'model_type': 'max', 'keepdims': False},
                                            {'model_type': 'avg', 'keepdims': True},
                                            {'model_type': 'avg', 'keepdims': False}],
                         ids = ['model_type-max-keepdims-True',
