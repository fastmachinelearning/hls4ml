...
@pytest.mark.parametrize('structure_type', [SUPPORTED_STRUCTURES.UNSTRUCTURED, SUPPORTED_STRUCTURES.STRUCTURED,
...
def test_dense_regularizer(structure_type, dense):
    ...
    dense_weights[0] = w
    model.layers[0].set_weights(dense_weights)
    regularizer = DenseRegularizer(alpha=0.5, beta=0.5, structure_type=structure_type, pattern_offset=pattern_offset,
