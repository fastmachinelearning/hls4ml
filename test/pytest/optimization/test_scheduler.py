...
from hls4ml.optimization.scheduler import ConstantScheduler, BinaryScheduler, PolynomialScheduler
...
def test_polynomial_scheduler():
    ...
    # Assert initial sparsity correct
    scheduler = PolynomialScheduler(maximum_steps, initial_sparsity=initial_sparsity, final_sparsity=target_sparsity, decay_power=decay_power)
    np.testing.assert_allclose(scheduler.get_sparsity(), initial_sparsity)
